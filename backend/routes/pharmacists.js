...
// // Get all pharmacists (requires auth)
...
// // Get pharmacist by ID (requires auth)
...
// // Create new pharmacist (protected: admin only)
// router.post('/',
//   requireAuth,
//   requireAdmin,
//   [
...
// // Authenticate pharmacist (for login) — issues httpOnly cookie on success
// router.post('/auth',
//   [
//     body('pNumber')
//       .trim()
